...
function displayGrandParent(father1Id, mother1Id, father2Id, mother2Id, titre, containerClass, data) {
  ...
  if (father1) {
      ...
      pere1HTML += '<p><a href="html/arbreperso.html?id=' + father1.id  + '" style="text-decoration: none; color: inherit;">' + father1.nom + ' ' + father1.prenom + '</a></p>';
      pere1HTML += '</div>';
      container.innerHTML += pere1HTML;
  }
  if (mother1) {
      var mere1HTML = '<div class="' + containerClass + ' female">';
      mere1HTML += '<p><a href="html/arbreperso.html?id=' + mother1.id  + '" style="text-decoration: none; color: inherit;">' + mother1.nom + ' ' + mother1.prenom + '</a></p>';
      mere1HTML += '</div>';
  ...
  if (father2) {
      ...
      pere2HTML += '<p><a href="html/arbreperso.html?id=' + father2.id  + '" style="text-decoration: none; color: inherit;">' + father2.nom + ' ' + father2.prenom + '</a></p>';
  ...
  if (mother2) {
      ...
      mere2HTML += '<p><a href="html/arbreperso.html?id=' + mother2.id  + '" style="text-decoration: none; color: inherit;">' + mother2.nom + ' ' + mother2.prenom + '</a></p>';
      mere2HTML += '</div>';
...
function displayRelations(fatherId, motherId, containerClass, data) {
    ...
    if (father || mother) {
      ...
      if (father) {
        ...
        pereHTML += '<p><a href="html/arbreperso.html?id=' + father.id  + '" style="text-decoration: none; color: inherit;">' + father.nom + ' ' + father.prenom + '</a></p>';
        pereHTML += '</div>';
        container.innerHTML += pereHTML;
      }
      if (mother) {
        var mereHTML = '<div class="' + containerClass + ' female">';
        mereHTML += '<p><a href="html/arbreperso.html?id=' + mother.id  + '" style="text-decoration: none; color: inherit;">' + mother.nom + ' ' + mother.prenom + '</a></p>';
        mereHTML += '</div>';
...
function displayChildrenAndGrandChildren(parentId, containerClass, data) {
  ...
  if (children.length > 0) {
      ...
      children.forEach(function(child) {
          ...
          childHTML += '<p><a href="html/arbreperso.html?id=' + child.id  + '" style="text-decoration: none; color: inherit;">' + child.nom + ' ' + child.prenom + '</a></p>';
          childHTML += '</div>';
  ...
  if (grandChildren.length > 0) {
      ...
      grandChildren.forEach(function(grandChild) {
        ...
        grandChildHTML += '<p><a href="html/arbreperso.html?id=' + grandChild.id  + '" style="text-decoration: none; color: inherit;">' + grandChild.nom + ' ' + grandChild.prenom + '</a>';
